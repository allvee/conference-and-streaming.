...
function table_initialize_firewall_user() {
    ...
    $('#add_button').html('<div class="frmFldAcc  col-md-5"></div>' +
        ...
        '<button type="button" class="btn btn-primary btn-test" style="background-image:url(img/add.png); margin-top: 7%; font-size: 17px; background-position: center center" onclick="show_firewall_user_form(); return false;">' +
        '</button> </div>' +
...
function edit_firewall_users(obj, action_id) {
    ...
    display_content_custom('1575', '#modalData');
...
function show_firewall_user_form() {
    write_activity_log('SHOW_USER_FORM', 'SHOW_USER_FORM', cms_url['activity_log']);
    display_content_custom('1575', '#modalData');
