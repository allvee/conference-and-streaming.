$('document').ready(function () {
    ...
    }else if(sso_username != '' && sso_password != ''){
		var auth_user = new Object();
		auth_user.UserID = sso_username;
		auth_user.UserName = sso_username;
		auth_user.UserType = "Super User";
		auth_user.layoutId = "7";
		auth_user.layoutId = 0;
		var auth_session_data = JSON.stringify(auth_user);
		console.log(auth_session_data);
