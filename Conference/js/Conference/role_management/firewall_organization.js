...
function table_initialize_firewall_organization() {
    ...
    if (permission.add_permission != 'yes') {
        ...
        $('#add_button').html('<div class="frmFldAcc  col-md-5"></div>' +
            ...
            '<button type="button" class="btn btn-primary btn-test" style="background-image:url(conference/img/add.png); margin-top: 7%; font-size: 17px; background-position: center center" onclick="show_firewall_organization_form(); return false;">' +
            '</button> </div>' +
